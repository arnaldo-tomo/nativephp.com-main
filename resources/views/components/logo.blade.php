...
<svg
    ...
    class="h-600 w-auto"
>
    <!-- Laravel Diamond Icon with Lusophone Colors -->
    <g transform="translate(5, 10)">
        <!-- Main Laravel diamond shape with gradient -->
        <defs>
            <linearGradient id="laravelGradient" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <!-- Laravel diamond scaled and positioned -->
        <path
            fill="url(#laravelGradient)"
            fill-rule="evenodd"
