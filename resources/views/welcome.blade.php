<x-layout title="Baking Delicious Native Apps">
    ...
    <section class="mt-10 px-5 md:mt-14" aria-labelledby="hero-title">
        ...
        <header class="group/header relative isolate grid place-items-center gap-0.5 text-center dark:text-white/90">
            ...
            <div class="relative">
                ...
                {{-- Blurred circle --}}
                <div class="absolute -top-20 size-48 rounded-full bg-white/60 blur-[100px] md:-right-32 md:size-60 dark:-top-80 dark:right-1/2 dark:-z-50 dark:size-80 dark:translate-x-1/2 dark:bg-[#444892]/80"
                ...
                {{-- Glass shape --}}
                <div class="absolute top-16 -left-12 size-6 rounded-tl-3xl rounded-tr-xl rounded-br-3xl rounded-bl-xl bg-[#5A31FF]/10 ring-1 ring-white/50 backdrop-blur-xs min-[400px]:top-18 min-[400px]:-left-14 min-[400px]:size-8 md:top-[5.6rem] md:-left-18 md:size-10 dark:hidden dark:ring-gray-700/50"
                    x-init="() => {
                        motion.animate(
                            $el, {
                                rotate: [-90, 0],
                ...
                <div x-init="() => {
                    ...
                    <div class="relative -top-1.5 -mr-6 flex items-end gap-1">
                        ...
                        {{-- Play button --}}
                        <a href="https://www.youtube.com/watch?v=CsM66a0koAM" target="_blank" rel="noopener"
                    ...
                    <div>
                        ...
                        <a href="https://www.youtube.com/watch?v=CsM66a0koAM" target="_blank" rel="noopener"
                            ...
                            <img src="{{ Vite::asset('resources/images/simon2025laraconeu.webp') }}"
            ...
            <h1 x-init="() => {
                ...
                class="truncate text-6xl font-extrabold uppercase min-[400px]:text-7xl md:text-8xl" aria-hidden="true">
                Lusophone
            </h1>
        ...
        <div class="grid place-items-center pt-4 lg:hidden">
            <a href="https://www.youtube.com/watch?v=CsM66a0koAM" target="_blank" rel="noopener" class="group relative"
                aria-label="Watch Simon Hamp's talk on building mobile apps with PHP">
                {{-- Play button --}}
                <div class="absolute top-1/2 right-1/2 grid size-16 translate-x-1/2 -translate-y-1/2 place-items-center rounded-full bg-white/10 text-white ring-1 ring-white/10 backdrop-blur-sm transition duration-300 ease-in-out will-change-transform group-hover:scale-110 group-hover:text-[#d4fd7d]"
                    aria-hidden="true">
                    <x-icons.play-button x-init="() => {
                        motion.animate(
                            $el, {
        ...
        <div class="mt-10 flex flex-wrap-reverse items-center justify-center gap-4 sm:flex-nowrap"
            ...
            <div x-init="() => {
                ...
                <div class="transition duration-300" :class="{ 'opacity-60 grayscale': mobileHover }">
                    <a href="/docs/desktop/1"
                        ...
                        x-on:mouseenter="desktopHover = true" x-on:mouseleave="desktopHover = false">
                        {{-- Arrow --}}
            ...
            <div x-init="() => {
                ...
                <div class="transition duration-300" :class="{ 'opacity-60 grayscale': desktopHover }">
                    <a href="/mobile"
                        ...
                        x-on:mouseenter="mobileHover = true" x-on:mouseleave="mobileHover = false">
    ...
    {{-- Marcel talk --}}
    <section class="mx-auto mt-20 max-w-5xl px-5" aria-labelledby="laracon-talk-title">
        <div class="flex flex-col items-center gap-5 lg:flex-row lg:justify-between">
            ...
            <div class="text-center lg:max-w-96 lg:text-left">
                ...
                <h2 id="laracon-talk-title" x-init="() => {
                    motion.inView($el, (element) => {
                        motion.animate(
                            $el, {
                                opacity: [0, 1],
            ...
            <div class="grid place-items-center">
                <a href="https://www.youtube.com/watch?v=iG7VscBFnqo" target="_blank" rel="noopener"
                    ...
                    {{-- Image --}}
                    <img src="{{ Vite::asset('resources/images/marcel2023laraconus.webp') }}"
                        alt="Marcel Pociot at Laracon US - Building Desktop Applications with PHP"
                        class="w-full max-w-[505px] rounded-2xl ring-1 ring-black/10" width="505" height="284"
                        loading="lazy" />
                </a>
            </div>
        </div>
    ...
    <section class="mx-auto mt-20 max-w-5xl px-5" aria-labelledby="sponsors-title">
        ...
        <div class="divide-y divide-[#242A2E]/20 *:py-8">
            ...
            <div class="flex flex-col items-center justify-between gap-x-10 gap-y-5 md:flex-row md:items-start"
                ...
                <h3 id="featured-sponsors-title" x-init="() => {
                    motion.inView($el, (element) => {
                        motion.animate(
                            $el, {
                                opacity: [0, 1],
        ...
        <div x-init="() => {
            ...
            <a href="/docs/getting-started/sponsoring"
                ...
                <div class="inline-flex shrink-0 flex-col-reverse items-center gap-x-5 gap-y-3 md:flex-row">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        ...
                        aria-hidden="true">
                        <path class="text-[#e8e4f8] dark:text-[#31416e]/30" fill="currentColor"
